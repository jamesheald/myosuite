...
def compute_ppo_loss(
  ...
  target_action_log_probs, entropy = parametric_action_distribution.log_prob_entropy(policy_logits, data.extras['policy_extras']['raw_action'], rng, precoder_state, data.observation['precoder'])
  ...
  entropy_loss = entropy_cost * -entropy.mean()
